...
@Component({
  selector: 'app-something-no-secure',
  templateUrl: './something-no-secure.component.html',
  styleUrls: ['./something-no-secure.component.scss'],
})
export class SomethingNoSecureComponent {
  /**
